...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    ...
    echo '<a href="formpp.php" class="btn btn-hijau mt-3 d-block text-center">Kembali ke Form</a>';
    exit;
}
...
if (!empty($errors)) {
    ...
    echo '</ul></div>';
    echo '<a href="formpp.php" class="btn btn-hijau mt-3 d-block text-center">Kembali & Perbaiki</a>';
    exit;
}
